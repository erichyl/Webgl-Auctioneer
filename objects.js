...
//--------------- CUBE WITH 1 TEXTURED SIDE --------------

Cube1Tex = {};
Cube1Tex.numVertices = 36;

Cube1Tex.pointsArray = [];
Cube1Tex.normalsArray = [];
Cube1Tex.colorsArray = [];
Cube1Tex.texCoordsArray = [];
...
const cube1TexCoord = 
   [1, 1, 0, 1, 0, 0,      // v0-v1-v2 (front)
    ...
    0, 0, 0, 0, 0, 0,      // v0-v3-v4 (right)
    0, 0, 0, 0, 0, 0,      // v4-v5-v0

    0, 0, 0, 0, 0, 0,      // v0-v5-v6 (top)
    0, 0, 0, 0, 0, 0,      // v6-v1-v0

    0, 0, 0, 0, 0, 0,     // v1-v6-v7 (left)
    0, 0, 0, 0, 0, 0,      // v7-v2-v1

    0, 0, 0, 0, 0, 0,      // v7-v4-v3 (bottom)
    0, 0, 0, 0, 0, 0,      // v3-v2-v7

    0, 0, 0, 0, 0, 0,     // v4-v7-v6 (back)
    0, 0, 0, 0, 0, 0];    // v6-v5-v4

Cube1Tex.init = function (program) {
    let count = 0;
    let texCount = 0;
    for (let i = 0; i < vertices1.length; i++) {
        this.pointsArray.push(vec4(vertices1[count], vertices1[count + 1], vertices1[count + 2], 1.0));
        ...
        this.texCoordsArray.push(cube1TexCoord[texCount], cube1TexCoord[texCount + 1]);
